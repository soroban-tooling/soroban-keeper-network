 ...
 */
export declare function updateVerifier(client: KeeperRegistryClient, params: UpdateVerifierParams, options?: BuildTransactionOptions): Promise<TransactionResult>;
//# sourceMappingURL=updateVerifier.d.ts.map